...
function ScrollDown({width, height, delay, color, sx}) {
    return (
        <div className="scoll-icon" sx={sx}>
            <motion.svg transition={{duration: 0.5, delay: delay}} initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0}} width={width} height={height} fill={color} stroke={color} stroke-width="1px" viewBox="0 0 8 5" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
