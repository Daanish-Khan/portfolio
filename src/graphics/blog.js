...
function Blog({width, height, delay, color}) {
    return (
        <div style={{cursor:"pointer"}} className="blog-icon">
            <motion.svg transition={{duration: 1, delay: delay + 0.5}} initial={{ fillOpacity: 0 }} animate={{ fillOpacity: 1}} width={width} height={height} fill={color} stroke={color} strokeWidth="1px" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 48 48">
