...
function About({width, height, delay, color}) {
    return (
        <motion.div style={{cursor:"pointer"}} className="about-icon">
            <motion.svg style={{fillRule:"evenodd", clipRule:"evenodd", strokeLinejoin: "round", strokeMiterlimit:2, display:"inline-flex"}} transition={{duration: 1, delay: delay + 0.5}} initial={{ fillOpacity: 0}} animate={{ fillOpacity: 1 }} fill={color} stroke={color} strokeWidth="1px" width={width} height={height} viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve">
                <g id="Icon">
                    <g>
